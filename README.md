...
Este proyecto lleva por título Algoritmos para el Cálculo de Testores Típicos y fue desarrollado para la asignatura de Matemáticas Discretas (202510). El objetivo principal del trabajo es la implementación computacional y el análisis experimental de algoritmos clave utilizados para el cálculo de todos los Testores Típicos de una matriz básica. Se exploran conceptos fundamentales como la matriz de diferencias, la matriz básica, la densidad, el concepto de testor y la tipicidad. Específicamente, el proyecto busca implementar los algoritmos YYC (Incremental) y BT para comparar su desempeño, y se diseñó un conjunto de experimentos utilizando los operadores phi, theta y gamma para generar matrices sintéticas de prueba y evaluar la eficiencia de los algoritmos bajo distintas condiciones.
